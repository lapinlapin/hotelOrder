/*
 *   @name Директива Шага 2 (даты)
 *   Забирает значения из инпутов, приводит к типам unix,
 *   получает разницу, пишет данные как в сервис с параметрами, так и в сервис прайс,
 *   валидирует данные
 *   зы. Хотелось автоматизировать данный процесс, в отличие от Шага3, поэтому работает таймер
 */
hotelApp
	.directive('stepDate', [
		'$stepError',
