/*
 *   @name Директива услуг
 *   Разворачивается из массива. Пишет данные в сервисы параметров и прайса.
 *   При выборе двд и приставки, телевизор автоматически включается, но жесткой привязки нет,
 *   также заполнение данных здесь не обязательно, "вперед" сработает
 */
hotelApp
